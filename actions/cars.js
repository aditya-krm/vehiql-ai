...
export async function processCarImageWithAI(file) {
  try {
    ...
    const prompt = `
      ...
      Only respond with the JSON object and make sure dont give $ and , in the price, nothing else.
    `;
...
export async function addCar({ carData, images }) {
  try {
    ...
    // Initialize Supabase admin client to bypass RLS for storage operations
